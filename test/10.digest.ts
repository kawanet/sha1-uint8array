...
describe(TESTNAME, () => {
    it("0 byte to hex", () => {
        ...
        assert.equal(createHash("sha1").update(input).digest("hex"), "da39a3ee5e6b4b0d3255bfef95601890afd80709");
    });
    ...
    it("0 byte to Uint8Array", () => {
        ...
        assert.equal(toHEX(createHash("sha1").update(input).digest()), "da-39-a3-ee-5e-6b-4b-0d-32-55-bf-ef-95-60-18-90-af-d8-07-09");
    });
    ...
    it("43 bytes string", () => {
        ...
        assert.equal(createHash("sha1").update(input).digest("hex"), "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12");
    });
    ...
    it("117 bytes string", () => {
        ...
        assert.equal(createHash("sha1").update(input).digest("hex"), "8a6b5061c2724db215c1f23de00272f39bfa2cb5");
    });
    ...
    it("UTF-8 characters", () => {
        ...
        assert.equal(createHash("sha1").update(input).digest("hex"), "2bed426b24f5e9b37866721b7e0e2509342bcd05", "single text at once");
